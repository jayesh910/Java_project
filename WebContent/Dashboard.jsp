...
<body background="btstrap/p7.jpg">
  ...
  <div class="d-flex" id="wrapper">
   ...
   <div id="page-content-wrapper" >
      ...
      <table>
      <tr bgcolor="#A52A2A"><th>Recently Viewed</th></tr>
      <tr><td></td></tr>
      </table>
     ...
     <p>Add and share your personalized videos related to ALM </p>
     <p>	and help your Trainee Peers to success. </p>
     <table>
     <tr bgcolor="#A52A2A"><th>Add Title</th><th>Add Link</th><th>Add Description</th></tr>
     
     <tr bgcolor="#DEB887"><th><input type="text" name="addname" ></th><th><input type="text" name="addlink"></th><th><input type="text" name="adddesc"></th></tr>
    
	 <tr><td colspan="3" align="center"><input type="submit" value="Add" class="btn btn-warning"></td></tr>
